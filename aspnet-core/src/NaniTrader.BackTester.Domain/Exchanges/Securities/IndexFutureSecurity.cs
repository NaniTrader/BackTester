...
{
    public class IndexFutureSecurity : FullAuditedEntity<Guid>
    {
        // here for ef core
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor.
        ...
        internal IndexFutureSecurity(Guid id, string name, string description, Exchange exchange, IndexSecurity underlying) : base(id)
        {
            SetName(name);
